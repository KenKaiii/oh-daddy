 ...
 * one click away from any page. State is shared via context so any page
 * reading it (e.g. the Automations list) stays in sync with this switch
 * without a page reload.
 */
function SystemToggle() {
	const { enabled, toggling, toggle } = useAutomationsEnabled();
